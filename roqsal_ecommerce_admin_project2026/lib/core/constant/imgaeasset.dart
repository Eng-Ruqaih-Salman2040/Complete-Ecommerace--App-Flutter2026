...
//------------------------------ Admin Images ---------------------------
  static const String adminrootImages = "assets/admin";
  static const String messageImage = "$adminrootImages/message.png" ;
  static const String notificationsImage = "$adminrootImages/notifications.png" ;
  static const String productsImage = "$adminrootImages/products.png" ;
}
