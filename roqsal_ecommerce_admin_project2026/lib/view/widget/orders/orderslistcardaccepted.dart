            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  //if (listdata.ordersStatus! == "3") // 3  in deiivery app
                  if (listdata.ordersStatus! == "1")  // 1 in admin app
                    MaterialButton(
                      onPressed: () {
                        //controller.deleteOrder(listdata.ordersId!);
                       // controller.doneDelivery( listdata.ordersId!,listdata.ordersUsersid!);
                        controller.donepPrepare( listdata.ordersId!,listdata.ordersUsersid!,listdata.ordersType!);
                      },
                      color: AppColor.thirdColor,
                      textColor: AppColor.secondColor,
